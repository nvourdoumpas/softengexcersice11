...
public class Administrator extends JFrame {
	...
	public Administrator() {
		...
		lblNewLabel_1.setBounds(10, 100, 159, 20);
		...
		motime.setHorizontalAlignment(SwingConstants.RIGHT);
		motime.setEditable(false);
		motime.setBounds(179, 100, 211, 20);
		contentPane.add(motime);
		motime.setColumns(10);
		
		takings = new JTextField();
		takings.setHorizontalAlignment(SwingConstants.RIGHT);
		takings.setEditable(false);
		takings.setColumns(10);
		takings.setBounds(179, 162, 211, 20);
		...
		fpa.setColumns(10);
		fpa.setBounds(179, 193, 211, 20);
		contentPane.add(fpa);
		
		profits = new JTextField();
		profits.setHorizontalAlignment(SwingConstants.RIGHT);
		profits.setEditable(false);
		profits.setColumns(10);
		profits.setBounds(179, 224, 211, 20);
		contentPane.add(profits);
		
		//Υπολογισμός του λογιστικού φύλλου της εταιρίας
		...
		calc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					...
					checked=false;//Junit test για τον υπολογισμό στατιστικών απο τον διαχειριστή
